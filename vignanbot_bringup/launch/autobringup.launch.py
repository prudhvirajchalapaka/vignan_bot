...
def generate_launch_description():
  pkg_share = launch_ros.substitutions.FindPackageShare(package='vignanbot_description').find('vignanbot_description')
  navigation_dir = os.path.join(get_package_share_directory('vignanbot_navigation'), 'launch')
  rviz_launch_dir=os.path.join(get_package_share_directory('vignanbot_description'), 'launch')
  gazebo_launch_dir=os.path.join(get_package_share_directory('vignanbot_gazebo'), 'launch')
  ydlidar_launch_dir=os.path.join(get_package_share_directory('ydlidar'), 'launch')
  cartographer_launch_dir=os.path.join(get_package_share_directory('vignanbot_slam'), 'launch')
  prefix_address = get_package_share_directory('vignanbot_slam') 
  default_model_path = os.path.join(pkg_share, 'models/urdf/vignanbot_simple.xacro')
  ...
  map_directory = os.path.join(get_package_share_directory(
        'vignanbot_bringup'), 'maps','room2.yaml')
  use_sim_time=LaunchConfiguration('use_sim_time')
  exploration=LaunchConfiguration('exploration')   
  default_rviz_config_path = os.path.join(get_package_share_directory('vignanbot_description'), 'rviz/vignanbot_sensor_display.rviz')
